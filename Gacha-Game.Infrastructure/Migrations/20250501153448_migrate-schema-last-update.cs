...
{
    /// <inheritdoc />
    public partial class migrateschemalastupdate : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostPerPull = table.Column<int>(type: "int", nullable: false),
                    PullsForGuaranteedRarity = table.Column<int>(type: "int", nullable: false),
                    BannerImageUrl = table.Column<string>(type: "nvarchar(200)", maxLength: 200, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    Level = table.Column<int>(type: "int", nullable: false),
                    ColorCode = table.Column<string>(type: "nvarchar(8)", maxLength: 8, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PullCount = table.Column<int>(type: "int", nullable: false, defaultValue: 1),
                    PullType = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                    UserId = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    BannerId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_GachaPulls", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GachaPulls_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_GachaPulls_GachaBanners_BannerId",
                        column: x => x.BannerId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AttackBase = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Characters_ElementTypes_ElementTypeId",
                        column: x => x.ElementTypeId,
                        principalTable: "ElementTypes",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Characters_Rarities_RarityId",
                        column: x => x.RarityId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_BannerCharacters_GachaBanners_BannerId",
                        column: x => x.BannerId,
                        principalTable: "GachaBanners",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PullResults", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PullResults_GachaPulls_PullId",
                        column: x => x.PullId,
                        principalTable: "GachaPulls",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_PullResults_Inventories_InventoryId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Characters_ElementTypeId",
                table: "Characters",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GachaPulls_BannerId",
                table: "GachaPulls",
                column: "BannerId");

            migrationBuilder.CreateIndex(
                name: "IX_GachaPulls_UserId",
                table: "GachaPulls",
                column: "UserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_PullResults_InventoryId",
                table: "PullResults",
                column: "InventoryId");

            migrationBuilder.CreateIndex(
                name: "IX_PullResults_PullId",
                table: "PullResults",
                column: "PullId");
        }
